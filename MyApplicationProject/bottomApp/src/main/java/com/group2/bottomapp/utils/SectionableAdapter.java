package com.group2.bottomapp.utils;
...
import com.group2.bottomapp.Categories;
import com.group2.bottomapp.Ingredient;
...
public abstract class SectionableAdapter extends BaseAdapter {
	 ...
	 */
	public SectionableAdapter(LayoutInflater inflater, int rowLayoutID, int headerID, int itemHolderID, int resizeMode, String[] items, String[] categories)
	{
		super();
