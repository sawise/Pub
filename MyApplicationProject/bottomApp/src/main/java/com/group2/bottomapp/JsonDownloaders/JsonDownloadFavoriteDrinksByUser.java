 ...
 */
public class JsonDownloadFavoriteDrinksByUser extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            APIManager.drinkByFavorite.clear();
            APIManager.drinkByFavorite.addAll(APIManager.getCocktailsFromJson(result));
        } catch (Exception e) {}
    }
