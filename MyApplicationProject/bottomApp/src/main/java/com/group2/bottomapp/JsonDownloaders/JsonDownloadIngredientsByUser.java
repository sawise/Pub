 ...
 */
public class JsonDownloadIngredientsByUser extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            APIManager.ingredientsByUser.clear();
            APIManager.ingredientsByUser.addAll(APIManager.getIngredientsFromJson(result));
        } catch (Exception e) {}
    }
