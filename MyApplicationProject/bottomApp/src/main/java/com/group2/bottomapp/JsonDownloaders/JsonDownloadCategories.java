 ...
 */
public class JsonDownloadCategories extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            APIManager.categories.clear();
            APIManager.categories.addAll(APIManager.getCategoriesFromJson(result));
        } catch (Exception e) {}
    }
