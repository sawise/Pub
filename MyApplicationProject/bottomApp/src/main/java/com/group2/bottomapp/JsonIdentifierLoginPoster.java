...
/**
 * Created by Svempa on 2013-12-12.
 */
public class JsonIdentifierLoginPoster {
    ...
    public JsonIdentifierLoginPoster(Context context, Login callback, String email, String identifier){
    ...
    public void PostJson(){
        ...
        new HttpAsyncTask().execute("http://dev2-vyh.softwerk.se:8080/bottomAppServer/json/users/identifierlogin");
    }


    public static String POSTIDENTIFIER(String url, User user){
        ...
        try {
            ...
            jsonObject.accumulate("identifier", user.getIdentifier());
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            return POSTIDENTIFIER(urls[0], user);
        }
